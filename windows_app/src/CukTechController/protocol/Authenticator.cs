    ...
    public class Authenticator
    {
        ...
        public async Task<bool> AuthenticateAsync(WindowsConnector connector, string token)
        {
            try
            {
                ...
                var expectedDevHmac = AuthHelper.HmacSha256(devKey_, saltInv.ToArray());
                ...
                // 发送我方 HMAC
                var ourHmac = AuthHelper.HmacSha256(appKey_, salt.ToArray());
                ...
                var rcvOk2 = await AuthHelper.WaitNotifyAsync(connector, "auth_data", timeoutSec: 3);
